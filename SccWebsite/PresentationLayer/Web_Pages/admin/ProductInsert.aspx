<%@ Page Title="" Language="C#" MasterPageFile="~/Web_Pages/admin/AdminMasterPage.Master" AutoEventWireup="true" CodeBehind="ProductInsert.aspx.cs" Inherits="GUI.Web_Pages.admin.ProductInsert" %>
                ...
                <td>
                    <table class="information-container">
                        <tr>
                            ...
                            <td> 
                                <p> Mã sản phẩm </p>
                                <input class="input-layout" id="txt_ProId" runat="server" type="text" />
                            </td>
                        </tr>
                        <tr> 
                            <td> 
            ...
            <tr>
                <td>
                    <div style="margin-top: 20px;">
                        <input class="button" id="btn_InsertSubmit" runat="server" type="submit" onserverclick="btn_InsertSubmit_ServerClick" value="THÊM" />
                        &nbsp;
